...
class Usuario extends Controller
{
        ...
        if (isset($formulario)) :
            ...
            if (empty($formulario['nome']) || empty($formulario['email'])) :
                ...
                if ($formulario['email'] == $usuario->email) :
                    ...
                    Helper::mensagem('usuario', 'Perfil atualizado com sucesso');
            ...
            if ($usuario->id != $_SESSION['usuario_id']) :
                Helper::mensagem('post', 'Você não tem autorização para editar esse perfil', 'alert alert-danger');
            ...
            if (in_array("", $formulario)) :
                ...
                elseif ($formulario['senha'] != $formulario['confirma_senha']) :
                    ...
                    if ($this->usuarioModel->armazenar($dados)) :
                        Helper::mensagem('usuario', 'Cadastro realizado com sucesso');
                        Helper::redirecionar('usuario/login');
                    else :
    ...
    public function login()
    {
        ...
        if (isset($formulario)) :
            ...
            if (in_array("", $formulario)) :
                ...
                if (Helper::checarEmail($formulario['email'])) :
                    $dados['email_erro'] = 'O e-mail informado é invalido';
                else :
                    ...
                    if ($usuario) :
                        ...
                        Helper::mensagem('usuario', 'Usuario ou senha invalidos', 'alert alert-danger');
                    endif;
                endif;
            endif;
        else :
    ...
    */
    private function criarSessaoUsuario($usuario)
    {
        ...
        if($_SESSION['usuario_level'] == 3 ){
            Helper::redirecionar('admin');
        }
        else{
            Helper::redirecionar('usuario/perfil/'.$_SESSION['usuario_id'].' ');
        }
    }
