        ...
        <div class="col-lg-9">
            ...
            <div class="card">
                ...
                <div class="card-body bg-light">
                    <form name="login" method="POST" action="<?= URL ?>/admin/cadastrar/categoria" class="mt-4">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="texto" id="texto" class="form-control  <?= $dados['texto_erro'] ? 'is-invalid' : '' ?>" rows="3"><?= $dados['texto'] ?></textarea>
                            <div class="invalid-feedback">
                                <?= $dados['texto_erro'] ?>
                            </div>
                        </div>
                        <input type="submit" value="Cadastrar Categoria" class="btn fundoPrimario btn-block" data-toggle="tooltip" title="Cadastrar Categoria">
                    </form>
                </div>
            </div>
        </div>
