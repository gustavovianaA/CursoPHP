<div class="col-xl-4 col-md-6 mx-auto p-5">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form name="cadastrar" method="POST" action="<?= URL ?>/usuario/cadastrar" class="mt-4">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <input type="submit" value="Cadastrar" class="btn fundoSecundario btn-block">
                    </div>
                    <div class="col-md-6">
                        <small>
                            <a href="<?= URL ?>/usuario/login">Você tem uma conta? Faça login</a>
                        </small>
                    </div>
                </div>
